...
\begin{figure}[ht!]
    ...
    \caption{The variation of electron temperature (solid line) and electron density ($\mamthrm{N_{e}}$, dashed line) and density of neutral hydrogen atoms ($\mathrm{N_{H}}$, dot-dashed line) in the solar atmosphere as derived based on the 1-D model calculations by \sr{Ref. here}.}
    \label{fig_solar_atm}
\end{figure}
%% ############# %%
